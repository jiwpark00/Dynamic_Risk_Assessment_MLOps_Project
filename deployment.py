...
def import_files():
    ...
    if config['output_model_path'] == 'practicemodels':
        ...
        latestscore_path = os.getcwd() + '/' + model_path + \
            '/latestscore_' + todays_date + '.txt'
        latestscore_ = pd.read_csv(latestscore_path)
        ingestfiles_path = os.getcwd() + '/' + dataset_csv_path + \
            '/ingestedfiles_' + todays_date + '.txt'
        ingestfiles_ = pd.read_csv(ingestfiles_path, header=None)
...
store_model_into_pickle(
    model=lr_val,
    latestscore=latestscore_val,
    ingestfiles=ingestfiles_val)
